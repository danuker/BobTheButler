...
if __name__ == '__main__':
    ...
    parser.add_argument("--width",  type=int, help="number of chessboard squares wide", default = 9)
    parser.add_argument("--height",  type=int, help="number of chessboard squares high", default = 6)
